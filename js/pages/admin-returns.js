              ...
              <div class="return-admin-card">
                ...
                <div style="flex:1">
                  <div class="info-row">
                    ...
                    <a href="request-detail.html?id=${h(r.borrow_request_id)}" style="color:var(--primary)">
                ...
                <div class="actions-bar" style="flex-direction:column;align-items:flex-start;gap:.5rem">
                  <a href="request-detail.html?id=${h(r.borrow_request_id)}" class="btn btn-outline-primary btn-sm">ดูคำขอ</a>
                  ${r.status === 'pending' ? `
